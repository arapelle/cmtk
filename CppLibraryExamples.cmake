...
function(add_cpp_library_example example_name)
    ...
    if(WIN32)
        ...
        add_custom_command(TARGET ${example_name} POST_BUILD 
            COMMAND ${CMAKE_COMMAND} -E copy_if_different $<TARGET_RUNTIME_DLLS:${example_name}> $<TARGET_FILE_DIR:${example_name}>
    ...
    foreach(filename ${ARG_SOURCES})
        ...
        if(WIN32)
            ...
            add_custom_command(TARGET ${example_prog} POST_BUILD 
                              COMMAND ${CMAKE_COMMAND} -E copy_if_different $<TARGET_RUNTIME_DLLS:${example_prog}> $<TARGET_FILE_DIR:${example_prog}>
                              COMMAND_EXPAND_LISTS)
        endif()
    endforeach()
endfunction()
