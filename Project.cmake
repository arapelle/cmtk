...
function(_cmtk_set_name prefix)
    ...
    if(DEFINED ARG_NAME)
        ...
        set(${prefix}_FEATURE_NAME "${ARG_FEATURE_NAME}" PARENT_SCOPE)
        if(DEFINED ARG_BASE_NAME)
            set(${prefix}_BASE_NAME "${ARG_FEATURE_NAME}" PARENT_SCOPE)
        endif()
        ...
        set(${prefix}_CODE_FEATURE_NAME "${ARG_CODE_FEATURE_NAME}" PARENT_SCOPE)
        set(pj_name "${ARG_NAMESPACE}-${ARG_FEATURE_NAME}")
        set(${prefix}_NAME "${pj_name}" PARENT_SCOPE)
        set(${prefix}_CODE_NAME "${ARG_CODE_NAMESPACE}-${ARG_CODE_FEATURE_NAME}" PARENT_SCOPE)
    endif()
