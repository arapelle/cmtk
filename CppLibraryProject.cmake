...
macro(_resolve_build_var build_var)
  set_ifndef(${build_var} ON)
  if(${${build_var}} STREQUAL "OPTION")
    set(${build_var} "UNDEFINED")
  endif()
  set(build_values ON OFF UNDEFINED)
  if(NOT ${build_var} IN_LIST build_values)
    if(DEFINED ${${build_var}})
      set(${build_var} "${${${build_var}}}")
    else()
      set(${build_var} "UNDEFINED")
    endif()
  endif()
...
function(_add_classic_cpp_library)
  ...
  _resolve_build_var(ARG_BUILD_SHARED)
  _resolve_build_var(ARG_BUILD_STATIC)
  # Object target:
