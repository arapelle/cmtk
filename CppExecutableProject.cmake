...
function(add_cpp_executable executable_target)
    ...
    set(params "MAIN;OBJECT;CXX_STANDARD;RUNTIME_OUTPUT_DIRECTORY")
    set(lists "HEADERS;SOURCES;HEADERS_BASE_DIRS;BUILD_HEADERS_BASE_DIRS")
    # Parse args:
    ...
    if(DEFAULT_WARNING_OPTIONS)
        target_default_warning_options(${current_target})
    endif()
    if(DEFAULT_ERROR_OPTIONS)
        target_default_error_options(${current_target})
    endif()
    if(ARG_CXX_STANDARD)
